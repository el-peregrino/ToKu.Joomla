 ...
 * 
 * @var \ToKu\Component\JexContent\Administrator\View\Carousels\HtmlView $this 
 */
...
if ($manualOrder) {
    ...
    $draggable = [
        'class' => 'js-draggable',
        'data-url' => 'index.php?option=com_jexcontent&task=carousels.saveOrderAjax&' . Session::getFormToken() . '=1',
...
<form action="<?= Route::_('index.php?option=com_jexcontent&view=carousels'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <?php else: ?>
        <table class="table table-striped table-hover">
            <caption class="visually-hidden">
                <?= Text::_('COM_JEX_LIST_CAROUSELS_TITLE'); ?>,
            ...
            <thead>
                <tr>
                    ...
                    <th scope="col">
                        <?= HTMLHelper::_('searchtools.sort', 'COM_JEX_GRID_HEADING', 's.title', $listDir, $listOrder); ?>
                    </th>
                    <th scope="col">
            ...
            <tbody<?= Html::append($attributes); ?>>
                <?php foreach ($this->items as $i => $item): ?>
                    <?php /** @var \ToKu\Component\JexContent\Administrator\Table\CarouselTable $item */ ?>
                    <tr<?= Html::attribute('data-draggable-group', $item->catid, $manualOrder); ?>>
                        ...
                        <td class="center">
                            <?= HTMLHelper::_('jgrid.published', $item->published, $i, 'carousels.', true, 'cb'); ?>
                        </td>

                        <td scope="row">
                            <a href="<?= Route::_('index.php?option=com_jexcontent&task=carousel.edit&id=' . (int) $item->id); ?>" 
