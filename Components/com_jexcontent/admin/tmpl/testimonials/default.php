 ...
 * 
 * @var \ToKu\Component\JexContent\Administrator\View\Testimonials\HtmlView $this 
 */
...
if ($manualOrder) {
    ...
    $draggable = [
        'class' => 'js-draggable',
        'data-url' => 'index.php?option=com_jexcontent&task=testimonials.saveOrderAjax&' . Session::getFormToken() . '=1',
...
<form action="<?= Route::_('index.php?option=com_jexcontent&view=testimonials'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <?php else: ?>
        <table class="table table-striped table-hover">
            <caption class="visually-hidden">
                <?= Text::_('COM_JEX_LIST_TESTIMONIALS_TITLE'); ?>,
            ...
            <thead>
                <tr>
                    ...
                    <th scope="col">
                        <?= HTMLHelper::_('searchtools.sort', 'COM_JEX_GRID_HEADING', 's.author', $listDir, $listOrder); ?>
                    </th>
                    <th scope="col">
            ...
            <tbody<?= Html::append($attributes); ?>>
                <?php foreach ($this->items as $i => $item): ?>
                    <?php /** @var \ToKu\Component\JexContent\Administrator\Table\TestimonialTable $item */ ?>
                    <tr<?= Html::attribute('data-draggable-group', $item->catid, $manualOrder); ?>>
                        ...
                        <td class="center">
                            <?= HTMLHelper::_('jgrid.published', $item->published, $i, 'testimonials.', true, 'cb'); ?>
                        </td>

                        <td scope="row">
                            <a href="<?= Route::_('index.php?option=com_jexcontent&task=testimonial.edit&id=' . (int) $item->id); ?>" 
                                title="<?= Text::_('JACTION_EDIT'); ?> <?= $this->escape($item->author); ?>">
