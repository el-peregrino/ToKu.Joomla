 ...
 * 
 * @var \ToKu\Component\JexContent\Administrator\View\Testimonial\HtmlView $this 
 */
...
<form action="<?= Route::_('index.php?option=com_jexcontent&view=testimonial&layout=edit&id=' . (int) $this->item->id); ?>" method="post"
