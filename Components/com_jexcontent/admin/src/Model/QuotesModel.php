...
class QuotesModel extends ListModel
{
    ...
    {
        $record = Joomlib::getUserStateFromRequest('com_jexcontent.quotes.filter.catid', 'catid', null, 'int');
    ...
    protected function getListQuery()
    {
        ...
        $query->from($db->quoteName('#__jex_quotes', 'r'));
        ...
        if (!empty($tags)) {
            ...
            if (!empty($tagIds)) {
                $query->join('INNER',
                    ...
                    . ' AND ' . $db->quoteName('tm.type_alias') . ' = ' . $db->quote('com_jexcontent.quote')
                );
