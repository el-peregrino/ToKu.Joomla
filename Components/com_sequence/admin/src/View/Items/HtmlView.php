...
namespace ToKu\Component\Sequence\Administrator\View\Items;
...
class HtmlView extends BaseHtmlView
{
    ...
    {
        /** @var \ToKu\Component\Sequence\Administrator\Model\ItemsModel $model */
        $model = $this->getModel();
    ...
    {
        ToolbarHelper::title(Text::_('COM_SQ') . ': ' . Text::_('COM_SQ_LIST_ITEMS_TITLE'));
