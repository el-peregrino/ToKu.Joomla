 ...
 * @subpackage  mod_menu
 * 
 * This is the default T4 override copied from the t4 system plugin.
 */
...
<?php foreach ($list as $i => &$item)
{
	...
	switch ($item->type) :
		...
		case 'heading':
		case 'url':
			require ModuleHelper::getLayoutPath('mod_menu', 't4_' . $item->type);
			break;

		default:
			require ModuleHelper::getLayoutPath('mod_menu', 't4_url');
			break;
	endswitch;
